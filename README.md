...
```
لطفاً یک عبارت منظم (RegEx) برای الگوی زیر ایجاد کنید:
...
```
لطفاً کد لازم برای افزودن قابلیت زیر را ایجاد کنید:
...
```
لطفاً یک پیاده‌سازی پایه برای عملکرد زیر ایجاد کنید:
...
ساختار منطقی و مدولار
کامنت‌های توضیحی برای هر بخش منطق کسب و کار
مدیریت خطای مناسب
بهترین شیوه‌های [تکنولوژی مورد نظر] پیاده‌سازی کنید
```
...
```
لطفاً مدیریت خطای این کد [زبان برنامه‌نویسی] را بهبود دهید:
...
```
لطفاً این کد [زبان/فریمورک] را بررسی کرده و راهکارهای بهبود آن را ارائه دهید:

[کد مورد نظر]

لطفاً بر این جنبه‌ها تمرکز کنید:
