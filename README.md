...
- [مستندسازی حرفه‌ای](#مستندسازی-حرفهای)
  ...
  - [📣 تولید فایل README حرفه‌ای](#تولید-فایل-readme-حرفهای)
...
- [متحول‌سازی کد](#متحول‌سازی-کد)
  ...
  - [📣 ریفکتور کد با استاندار ها](#1-تبدیل-کد-به-استاندارد-روز)
  - [📣 استانداردسازی استایل کد](#استانداردسازی-استایل-کد)
  - [📣 یافتن و حذف باگ‌ها](#یافتن-و-حذف-باگها)
  - [📣 نوشتن تست‌ یونیت](#نوشتن-تستهای-یونیت)
  - [📣 ترجمه کد به زبان دیگر](#ترجمه-کد-به-زبان-دیگر)
  - [📣 ترجمه کردن کد به یک زبان دیگه](#ترجمه-کد-به-زبان-دیگر)
  - [📣 کامنت‌گذاری کد](#کامنتگذاری-کد)
- [تولید کد جدید](#تولید-کد-جدید)
  ...
  - [📣 کمک از مهندس نرم‌افزار سطح جهانی](#کمک-به-عنوان-مهندس-نرمافزار-سطح-بالا)
- [بررسی کد](#بررسی-کد)
